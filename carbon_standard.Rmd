...
## combine crop sp and tree sp
AFS_description_treecrop<-as.factor(paste(dataset$Crop_species, dataset$Tree_species))
...
profile_ID_interactions<-interaction(as.factor(dataset$Author_year), AFS_description_treecrop, as.factor(dataset$AFS_age_yrs))
